...
```json
{"type":"log",...,"tags":["status","plugin:elasticsearch@7.14.0","info"],...,"message":"Status changed from yellow to green - Ready","prevState":"yellow","prevMsg":"Waiting for Elasticsearch"}
```
